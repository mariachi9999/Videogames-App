    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.redes} data-testid="socialMedia">
                ...
                <a className={styles.anchor} href="https://github.com/mariachi9999" target="blank">
                ...
                <a className={styles.anchor} href="https://twitter.com/mariachi9999" target="blank">
                ...
                <a className={styles.anchor} href="https://api.whatsapp.com/send?phone=5492236690961&text=Hola!%20Quiero%20crear%20mi%20sitio%20web!" target="blank">
